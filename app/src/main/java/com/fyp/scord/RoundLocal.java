...
public RoundLocal(){}
    ...
    public RoundLocal(int hole1,int hole2,int hole3,int hole4,int hole5,int hole6,int hole7,int hole8,int hole9,
                      int hole10,int hole11,int hole12,int hole13,int hole14,int hole15,int hole16,int hole17,int hole18,String date,int front9, int back9, int score)
    {
        super(hole1,hole2,hole3,hole4,hole5,hole6,hole7,hole8,hole9,
        hole10,hole11,hole12,hole13,hole14,hole15,hole16,hole17,hole18,date);
        this.front9 = front9;
        this.back9 = back9;
        this.score = score;
    }
